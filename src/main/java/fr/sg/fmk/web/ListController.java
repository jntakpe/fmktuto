...
/**
 * Contrôleur permettant d'afficher une simple liste sans possibilité de création ou modification.
 * Les méthodes nécessaires à la suppression d'entités sont présentes dans ce contrôleur.
 * A étendre uniquement dans le cas d'une liste en mode 'consultation'.
 *
 * @author jntakpe
 * @see <a href="http://docs.spring.io/spring/docs/3.2.x/spring-framework-reference/html/mvc.html#mvc-controller">Spring MVC Controller docs</a>
 */
public abstract class ListController<T extends GenericDomain> {
